...
int main( void )
{
    ...
    int i, j, n = 0;
    int tam = sizeof(vetor) / sizeof(int); // o resultado é incrivelmente o tamanho do vetor o por que isso acontece eu ainda não entendi
    //printf("%d\n", tam); // o que eu usei para descobrir isso
